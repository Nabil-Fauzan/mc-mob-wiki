<x-app-layout>
    <div class="py-12 px-4 sm:px-6 lg:px-8 min-h-screen">
        <div class="max-w-7xl mx-auto">
            <!-- Hero Stats Segment -->
            <div class="mb-12">
                <h1 class="text-4xl font-black text-white tracking-tight mb-2">Command <span class="text-brand-500">Center</span></h1>
                <p class="text-gray-400 text-sm">Synchronized intelligence for researcher {{ auth()->user()->name }}.</p>
                
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                    <div class="glass-card p-6 rounded-[2rem] border-brand-500/20 group">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-[10px] font-black text-brand-500 uppercase tracking-widest">Bookmarks</span>
                        </div>
                    ...
                    <div class="glass-card p-6 rounded-[2rem] border-green-500/20 flex flex-col justify-center bg-gradient-to-br from-brand-500/10 to-transparent">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        @forelse($favorites as $mob)
                            <div class="glass-card p-4 rounded-[2rem] border-white/5 group hover:border-brand-500/30 transition-all">
