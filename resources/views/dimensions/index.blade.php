<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                <h1 class="text-3xl font-black text-white tracking-tight">Multiverse <span class="text-brand-500">Intelligence Bureau</span></h1>
                <p class="text-gray-400 text-sm italic">Advanced analytical data across all known dimensional planes.</p>
            </div>
            <div class="px-6 py-2 bg-brand-500/10 border border-brand-500/30 rounded-full">
                <span class="text-xs font-black text-brand-400 uppercase tracking-widest">Active Surveillance</span>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12 space-y-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="glass-card rounded-[3rem] p-10 mb-12 border-brand-500/10">
                <div class="text-center mb-10">
                    <h2 class="text-2xl font-black text-white uppercase tracking-tighter">Cross-Dimensional Threat Matrix</h2>
                    <div class="h-1 w-20 bg-brand-500 mx-auto mt-2 rounded-full"></div>
                </div>
            ...
            <div class="mt-24">
                <div class="text-center mb-12">
                    <span class="text-xs font-black text-brand-500 uppercase tracking-widest">Cross-Platform Analysis</span>
